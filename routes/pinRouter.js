...
pinRouter.get('/:pinId', errorHandler(auth.validationToken), errorHandler(pinController.getPinInfo));
pinRouter.delete('/:pinId', errorHandler(auth.validationToken), errorHandler(pinController.deletePin));
pinRouter.patch('/:pinId',errorHandler(auth.validationToken), errorHandler(pinController.patchPin));
